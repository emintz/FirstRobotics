...
#define CORRUPT_CONFIGURATION 8
#define INCOMPLETE_CONFIGURATION 9
#define CONFIG_NAMESPACE_CLOSE_FAILED 10
#define NON_VOLATILE_CLOSE_FAILED 11
#define COMMAND_QUEUE_BEGIN_FAILED 12
#define UNKNOWN_PANEL_DRIVER 13
#define I2C_STARTUP_FAILED 14
#define DS3231_STARTUP_FAILED 15
#define GPIO_INTERRUPT_STARTUP_FAILED 16
#define GPIO_CHANGE_STARTUP_FAILED 17
#define CAN_INIT_FAILED 18
#define CAN_START_FAILED 19
#define RJ45_BLINK_START_FAILED 20
